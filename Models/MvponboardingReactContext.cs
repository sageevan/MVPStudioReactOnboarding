...
public partial class MvponboardingReactContext : DbContext
{
    public MvponboardingReactContext()
    {
    }

    public MvponboardingReactContext(DbContextOptions<MvponboardingReactContext> options)
        : base(options)
    {
    }
